...
<MainCate tag="js">
    <div className="main_category_box">
        ...
        <MarginBox lang="en">
            자바스크립트에서 this는 현재 실행 컨텍스트에 따라 다르게 해석되는 특수한 키워드입니다. this는 실행 컨텍스트에 따라 바뀌게 되는데, 이 컨텍스트는 <StrongTag>함수가 어떻게 호출</StrongTag>되었는지에 달려있습니다.
        </MarginBox>
    </div>
        ...
        <div className="sub_cate_box">
            ...
            <div className="sub_contents">
                <MarginBox lang="en">
                    ...
                    3. #### Lexical scope
                        변수가 <StrongTag>선언된 위치</StrongTag>에 의해 그 범위가 결정되고, 자바스크립트는 렉시컬 스코프를 따른다.
...
<MainCate tag="js">
    ...
    <div className="main_category_box">
        ...
        <MarginBox lang="en">
            인터프리터가 코드를 실행하기 전에 함수, 변수, 클래스 또는 import의 <StrongTag><Highlight>선언문</Highlight>을 해당 스코프의 맨 위로 이동</StrongTag>시키는 과정이다.
...
<MainCate tag="js">
  <div className="main_category_box">
    ...
    <MarginBox lang="en">
        클로저는 <StrongTag>내부 함수가 외부 함수의 스코프에 접근</StrongTag>할 수 있는 것을 말한다.클로저는 함수가 생성될 때의 환경을 <StrongTag>기억</StrongTag>하고, 이 환경을 나중에도 사용할 수 있다.
